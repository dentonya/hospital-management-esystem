...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($patientNo) && empty($password_err)){
        ...
        $sql = "SELECT id,docemail, password FROM doctors WHERE docemail = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $docemail, $hashed_password);
      ...
      <p class="login-box-msg">Login To Continue</p>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group <?php echo (!empty($docEmail)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" name="docemail" class="form-control" placeholder="Email"value="<?php echo $docemail; ?>">
